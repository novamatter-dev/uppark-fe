...
A kiskorúak virtuális terekhez való hozzáférésének ellenőrzésével, tevékenységével és
következményeivel kapcsolatos minden felelősség a kiskorú szüleit vagy törvényes gyámját terheli, a
FAST PARK CO SRL mentesül minden felelősség alól.
Szolgáltatásainkat folyamatosan igyekszünk fejleszteni, ezért ezen általános feltételek módosulhatnak,
melyek azonnal megjelennek a weboldalon és az alkalmazáson keresztül. Ha továbbra is igénybe veszi
szolgáltatásainkat, feltételezzük, hogy elfogadja a jelen általános feltételek módosításait. Ha nem ért
...
Felhívjuk figyelmét, hogy a FAST PARK parkolási szolgáltatást nem nyújt, jelen általános
feltételek nem minősülnek parkolási szerződésnek. A FAST PARK csak a parkolási díj
...
előfizetés fizetése, jegyek vagy tömegközlekedési előfizetések fizetése stb.) bankkártya használatával,
telefonjával vagy más kompatibilis mobilkészülékével, ezen általános feltételeknek megfelelően;
A FAST PARK a FAST PARK CO KFT céget jelenti, amelynek székhelye Voluntari, Pipera Sugárút, 1B
szám, Cubic Cente Irodaház, 7. emelet, Ilfov megye, Románia, utódainkkal, leányvállalatainkkal vagy

társult vállalkozásainkkal, valamint bármely más olyan szervezettel együtt, amelyet az előfizető vagy
...
találja.
Győződjön meg arról, hogy a kiválasztott terület megegyezik a parkolóhely információs tábláin
lévő területtel.
A parkolóhely és a rendszám helyes megadásáért a megrendelő a felelős.
Az alkalmazásban található helymeghatározó szolgáltatás a legközelebbi parkolók irányába mutat.
A szolgáltatások bankkártyás fizetése esetén:
A fiók aktiválásához meg kell adnia egy érvényes bankkártya adatait, amely az Öné, valamint
telefonszámát az SMS fizetési lehetőséghez.
A fiók aktiválásakor az alkalmazás létrehoz egy biztonsági tokent, amely egy egyedi számítógépes kód,
amelyen keresztül mind a fiókja, mind az Ön által végrehajtott befizetések azonosításra kerülnek.
A token generálásához ideiglenesen 1 lej összegű befizetést kell felszámítania, amelyet a
számlaaktiválási eljárás sikeres befejezése után, ésszerű időn belül visszaküldünk, ami a kártyáját
kibocsátó bank szabályzatától függ.
A fiók aktiválásához a jármű rendszámát is regisztrálni kell.
A fiók aktiválása után igénybe veheti szolgáltatásainkat a parkolási fizetés megkönnyítése érdekében,
ami azt jelenti, hogy be kell azonosítania azt a területet, ahol tartózkodik, hogy a megfelelő, a
parkolóhelyre érvényes díjat tudjon fizetni.
Az alkalmazásban válassza ki a becsült parkolási időt.
Fizetési módot választhat: bankkártyával vagy SMS-ben.
Ha úgy dönt, hogy kártyás fizetést választ, tájékoztatjuk, hogy a fizetések feldolgozása a Netopia
Paymentsen keresztül történik. Ha bankja elutasítja a fizetési kérelmet, akkor a parkolási szolgáltatást
alternatív bankkártyával vagy SMS-ben kell fizetnie.
A bankkártyás fizetést követően az alkalmazás automatikusan elkészíti a kapcsolódó számlát, amelyet
feltölt a felhasználói fiókjában regisztrált e-mail címre. A FAST PARK nem kér és nem tárol semmilyen
adatot a kártyájával kapcsolatban, kivéve azokat, amelyek kizárólag az online fizetési platformhoz
szükségesek.
...
kód városonként eltérő. Ezért kérjük, ellenőrizze ezen adatok helyességét a tranzakció előtt.
Amikor a parkolás becsült időtartama lejár, értesítést kap, és lehetősége lesz meghosszabbítani ezt az
időtartamot. A parkolást a felhasználó manuálisan is meghosszabbíthatja a megfelelő díj megfizetésével.
Egyes települések esetében parkolási bérletek, jegyek és tömegközlekedési bérletek vásárlására is
lehetőséget biztosítunk az alkalmazáson keresztül, azonos fizetési feltételek mellett.
SMS-es fizetés esetén a tranzakció értéke megjelenik a mobiltelefon szolgáltató számláján, ugyanakkor a
fizetés regisztrációját igazoló SMS-t is kap.
Ha a számla nem töltődik be fiókjába, vagy nem kap visszaigazoló SMS-t a fizetést követő két percen
belül, az azt jelenti, hogy a tranzakció meghiúsult, olyan helyzet, amelyben úgy tekintik, hogy NEM fizette
ki a parkolási szolgáltatás árát, és ezért nincs joga az adott parkolóhelyen parkolni.
Az Ön felelőssége lesz a tranzakció feldolgozásának ellenőrzése. Nem vállalunk semmilyen
felelősséget abban az esetben, ha a fizetés feldolgozása nem történt meg, és ennek következtében a
parkolási szolgáltató szankcionálja Önt.
...
változhatnak.
Tájékoztatjuk, hogy nem vállalunk felelősséget sem Ön felé, sem harmadik felek felé a Szolgáltatások
módosításáért, felfüggesztéséért vagy megszakításáért.
Nem vállalunk felelősséget arra, hogy a Szolgáltatások zavartalanok vagy hibamentesek lesznek, és
semmilyen módon nem vállalunk felelősséget az esetleges megszakításokért vagy hibákért.

Ön elfogadja, hogy műszaki okok, technológiai korlátok (gsm jel/LTE), valamint elektronikus fizetési
feldolgozási technológia miatt fennakadások léphetnek fel vagy egyéb olyan okok miatt, amelyek nem a
FAST PARK hibájából adódik, amelyeket nem tudunk ellenőrizni, és amelyek befolyásolhatják a
szolgáltatások elérhetőségét vagy minőségét.
...
nem vállal felelősséget a fizetőeszköz nem rendeltetésszerű használatából eredő vagy a fizetőeszköz
tulajdonosán kívül más személyek által okozott panaszokért, és nem tudja visszaadni a befizetett
összeget, ha a felhasználó hibásan vagy a tulajdonos által jogosulatlan tranzakciót hajtott végre.
...
Az Ön által számunkra megadott adatokat a FAST PARK tulajdonában lévő szerveren tároljuk, amelyre
vonatkozóan minden fizikai és számítógépes biztonsági intézkedést megtettünk.
Rendszereinket szigorúan teszteljük és titkosító szoftverrel és biztonságos technológiával fejlesztjük.
Valamennyi banki adatot és tranzakciót tűzfalak is védenek, minden személyes adat biztonsága
érdekében. Bankkártya adatainak felhasználása a biztonsági előírásoknak megfelelően történik.
Regisztrált felhasználóként adatai csak a szolgáltatások jóváhagyott céljaira lesznek elérhetőek, egyéb
...
alkalmazzuk, valamint fiókját is felfüggesztjük, hogy megakadályozzuk az illetéktelen használatot. A
FAST PARK szolgáltatások ismételt használatához meg kell tennie a szükséges lépéseket a fizetési
adatok módosításához.

Ha úgy gondolja, hogy fiókja biztonsági kockázatot jelent, kérjük, tudassa velünk a webhelyen található
űrlapon keresztül. Ha úgy gondolja, hogy mobiltelefonját ellopták vagy visszaéltek vele, a lehető
leghamarabb értesítenie kell bennünket, hogy korlátozzuk a telefon további használatát a FAST PARK
...
Fenntartjuk magunknak a jogot, hogy megtagadjuk regisztrációját és/vagy felfüggesztjük és/vagy
...
megsértésétől. Ellenkező esetben Ön felelős minden olyan kárért, amely a FAST PARK szellemi
tulajdonjogainak Ön általi megsértéséből ered.
Bármilyen kommunikáció, beleértve, de nem kizárólagosan az e-maileket, képeket, hangfelvételeket,
videókat, grafikákat és/vagy egyéb anyagokat, amelyeket Ön közvetlenül, másolatban vagy bármilyen
más módon küldött a FAST PARK-nak vagy bármely alkalmazottnak, ügyvédnek vagy a mi
munkatársunknak. ügynökök és az ezen az oldalon található bejegyzések továbbításuk után a FAST
PARK tulajdonába kerülnek. Elküldésével Ön visszavonhatatlanul biztosítja számunkra ezen információk
díjmentes felhasználását.

KÜLÖNFÉLÉK

A FAST PARK felelőssége az Önt a FAST PARK Szolgáltatások igénybevétele miatt esetlegesen
elszenvedett közvetlen vagy közvetett károkért a megvásárolt termék, illetve a parkoló/jegy/előfizetés
értékére korlátozódik.
Ezek az általános feltételek az Ön és a FAST PARK között létrejött szerződést jelentik az általunk kínált
Szolgáltatások szabályozására. Ha bármely rendelkezés érvénytelen vagy végrehajthatatlan, az nem
befolyásolja a többi rendelkezés érvényességét és alkalmazhatóságát.
Ezen általános feltételek be nem tartása esetén a FAST PARK fenntartja a jogot bármely felhasználói fiók
előzetes figyelmeztetés nélküli felfüggesztésére vagy megszüntetésére. A szerződéses feltételek be nem
tartása miatti számla törlése nem jogosítja fel a felhasználót a befizetések visszatérítésére.

ALKALMAZANDÓ JOGSZABÁLYOK ÉS VITÁK
Ezeket az általános feltételeket a román jog szabályozza. Az Ön és a FAST PARK közötti esetleges
vitákat a vita felmerülésének napján hatályos román törvények szerint rendezzük, és a székhelyünk
illetékes bíróságai elé utaljuk megoldásra.
Ön vállalja továbbá, hogy betart minden jogszabályt, beleértve, de nem kizárólagosan az online
magatartásra vonatkozó jogszabályokat.
